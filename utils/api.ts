...
export const messagesAPI = {
  ...
  getConversations: async () => {
    return makeRequest("/conversations");
  },

  markAsRead: async (itemId: string, senderId: string) => {
    return makeRequest("/messages/mark-read", {
      method: "POST",
      body: JSON.stringify({ itemId, senderId }),
    });
  },
};
