...
interface ItemFiltersProps {
  ...
  onShowMyItemsOnlyChange: (value: boolean) => void;
}
...
export function ItemFilters({
  ...
  return (
    <View style={styles.container}>
      ...
      {/* My Items Toggle */}
      <Pressable
        style={[styles.myItemsToggle, showMyItemsOnly && styles.myItemsToggleActive]}
        onPress={() => onShowMyItemsOnlyChange(!showMyItemsOnly)}
      >
        <Text style={styles.myItemsToggleIcon}>{showMyItemsOnly ? "✓" : "○"}</Text>
        <Text style={[styles.myItemsToggleText, showMyItemsOnly && styles.myItemsToggleTextActive]}>
          Show My Items Only
        </Text>
      </Pressable>
